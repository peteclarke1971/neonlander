...
export const SurvivalEngine: React.FC<Props> = ({
  ...
  const LIGHT_STORM_SWEEP_SPEED = 9.0; // seconds to cross screen (slowed to 1/3 speed)
  ...
  useEffect(() => {
    ...
    const loop = (now: number) => {
      ...
      // Apply blackout darkness to entire scene
      const brightnessMultiplier = blackoutTransitionRef.current;
      ...
      // Fill terrain shape with black to mask stars behind it (both low and high-gfx)
      ...
      // Draw terrain with comet lighting and blackout
